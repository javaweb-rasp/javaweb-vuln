...
CREATE TABLE `sys_article` (
  ...
  CONSTRAINT `fk_sys_article_sys_user_id` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `sys_comment` (
  ...
  `user_id` int unsigned NOT NULL DEFAULT '0' COMMENT '评论的用户Id(未登录的用户Id为0)',
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `fk_sys_comment_sys_article_id` FOREIGN KEY (`article_id`) REFERENCES `sys_article` (`article_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_sys_comment_sys_user_id` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_comment` (`comment_id`, `article_id`, `user_id`, `comment_author`, `comment_content`, `comment_date`) VALUES (1, 100000, 1, 'admin', '<a href=\"download.php?fileName=../../../../../../../../../../../../../../etc/passwd\">任意文件下载测试</a>', '2021-06-16 10:44:55');
INSERT INTO `sys_comment` (`comment_id`, `article_id`, `user_id`, `comment_author`, `comment_content`, `comment_date`) VALUES (2, 100000, 1, 'admin', '测试', '2022-03-23 11:11:11');
INSERT INTO `sys_comment` (`comment_id`, `article_id`, `user_id`, `comment_author`, `comment_content`, `comment_date`) VALUES (3, 100005, 2, 'test', '反对战争，霸权主义！', '2022-03-24 01:11:11');
COMMIT;
